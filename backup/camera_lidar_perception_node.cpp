                                             ...
                                             const sensor_msgs::msg::CameraInfo::ConstSharedPtr& camera_info_msg)
{
  ...
  // This is optimal - let TF2 handle the transform chain internally
  ...
  sensor_msgs::msg::PointCloud2 detection_cloud_msg;  // Currently unused, but kept for future use
  ...
  for (size_t i = 0; i < detections_msg->detections.size(); ++i)
  {
    ...
    // Step 4b: Transform detected points to target frame (map)
    ...
    // Step 4c: Cluster the points to find the most relevant cluster
    ...
    // Step 4d: Create 3D bounding box from clustered points
...
// ============================================================================
// CREATE MARKER ARRAY - IMPROVED VERSION
// ============================================================================
    ...
    const vision_msgs::msg::Detection3DArray& detection3d_array_msg, const double& duration)
{
  ...
  for (size_t i = 0; i < detection3d_array_msg.detections.size(); i++)
  {
    ...
    // Skip unreasonably small boxes (likely noise)
    ...
    // ========================================================================
    // Main bounding box marker (semi-transparent cube)
    // ========================================================================
    ...
    box_marker.color.a = 0.3;  // Semi-transparent
    ...
    // 8 corners of the box (in box's local frame)
    ...
    // ========================================================================
    // Text label showing class and confidence
    // ========================================================================
